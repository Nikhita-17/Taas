...
function create_testcase_table(testcases,selected=false,stage="") {
    ...
    testcases.map((value, index) => {
        ...
        if(index == 0) {
            table_data += `
                <thead class="fixed_header">
                    ...
                    ${!selected ?'<th rowspan="2">Select</th>':''}
                        ...
                        <th colspan="2">
                            ${stage} Lab Testing with Virtual Clients (35 Days)
                        </th>
                    </tr>
                    <tr>
                        <th>
            ...
            table_data += `
                <tr style="${values[0].split(".")[2] == 0 || values[0].split(".")[3] == 0? 'background-color: #a9dfbf;' : ''}">
...
function downloadPDF() {
    ...
    const bannerImageUrl = "banner2.png"; 
            ...
            img.onload = function () {
                ...
                doc.text("Lab Testing with Virtual Clients", 40, 50, null, null, "center");
